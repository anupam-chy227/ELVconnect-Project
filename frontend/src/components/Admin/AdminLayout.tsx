      ...
      >
        ...
        <div className="relative flex items-start justify-between gap-3 border-b border-white/10 p-5">
          <Link href="/admin/dashboard" onClick={onClose} className="min-w-0">
            <ThemeLogo
              ...
              sizes="210px"
            />
            <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-[11px] font-black uppercase tracking-wide text-primary backdrop-blur">
                    ...
                    return (
                      <Link
                        ...
                        className={`group flex items-center justify-between gap-3 rounded-md border px-3 py-2.5 text-sm font-bold transition ${
                          active
                            ? "border-primary/45 bg-white text-slate-950 shadow-lg shadow-primary/20"
                        ...
                        {item.badge ? (
                          <span
                            className={`rounded-full px-2 py-0.5 text-[10px] font-black uppercase ${
                              active ? "bg-primary-subtle text-primary" : "bg-white/10 text-white/50"
                            }`}
                          >
                            {item.badge}
                          </span>
                          ...
                          <ChevronRight
                            className={`h-3.5 w-3.5 transition ${
                              active ? "text-primary" : "text-white/20 group-hover:text-white/50"
                            }`}
                          />
                        )}
                      </Link>
        ...
        <div className="relative border-t border-white/10 p-4">
          <Link
            ...
            className="mb-3 inline-flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-3 text-sm font-black text-on-primary shadow-lg shadow-primary/25 transition hover:-translate-y-0.5 hover:bg-primary-container hover:shadow-xl active:translate-y-0"
          >
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 items-center gap-3">
          <button
            ...
            className="rounded-md border border-slate-200 bg-white p-2 text-slate-600 shadow-sm transition hover:border-primary/35 hover:text-primary dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 md:hidden"
          >
            <Menu className="h-5 w-5" />
          </button>
          <div className="hidden h-10 w-10 items-center justify-center rounded-md bg-primary-subtle text-primary ring-1 ring-primary/25 dark:bg-primary-subtle dark:text-primary dark:ring-primary/35 sm:flex">
        ...
        <div className="hidden flex-1 justify-center px-6 lg:flex">
          <label className="relative w-full max-w-lg">
            ...
            <input
              ...
              className="h-10 w-full rounded-md border border-slate-200 bg-white/80 pl-10 pr-4 text-sm font-semibold text-slate-800 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-primary/45 focus:ring-4 focus:ring-primary-ring dark:border-slate-800 dark:bg-slate-900/80 dark:text-slate-100"
            />
          </label>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="hidden items-center gap-1 rounded-full border border-slate-200 bg-slate-50 p-1 dark:border-slate-800 dark:bg-slate-900 sm:flex">
            <button className="rounded-full bg-primary px-3 py-1 text-xs font-black text-on-primary shadow-sm shadow-primary/20">
              EN
            </button>
          ...
          <button
            ...
            className="rounded-md border border-slate-200 bg-white p-2 text-slate-600 shadow-sm transition hover:border-primary/35 hover:text-primary dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"
          >
          ...
          <button
            ...
            className="relative rounded-md border border-slate-200 bg-white p-2 text-slate-600 shadow-sm transition hover:border-primary/35 hover:text-primary dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200"
          >
          ...
          <div className="flex items-center gap-3 rounded-md border border-slate-200 bg-white px-2 py-1.5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            {user?.profile.avatar ? (
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-md bg-primary text-sm font-black text-on-primary shadow-sm shadow-primary/20">
